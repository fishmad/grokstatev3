    ...
    public function configure()
    {
        return $this->afterCreating(function (Property $property) {
            ...
            $property->address()->create([
                ...
                'postcode_number' => $suburb ? $suburb->postcode : fake()->postcode(),
                'suburb_name' => $suburb ? $suburb->name : fake()->city(),
                'state_name' => $state ? $state->name : fake()->state(),
                'address_line_1' => fake()->streetAddress(),
                'address_line_2' => fake()->optional()->secondaryAddress(),
                'country_name' => $australia ? $australia->name : 'Australia',
                'city_name' => fake()->city(),
                'formatted_address' => fake()->address(),
                'street_type' => fake()->randomElement(['Street', 'Avenue', 'Road', 'Boulevard', 'Lane']),
                'is_unit' => fake()->boolean(20), // 20% chance of being a unit
                'is_lot' => fake()->boolean(10), // 10% chance of being a lot
                'is_complex' => fake()->boolean(5), // 5% chance of being a complex
                'complex_number' => fake()->optional()->buildingNumber(),
                'complex_street_name' => fake()->optional()->streetName(),
                'complex_name' => fake()->optional()->company(),
